...
@OnlyIn(Dist.CLIENT)
public class DisplayCaseScreen extends ContainerScreen<GUICaseContainer> {

    private static final ResourceLocation DISPLAY_CASE_GUI = new ResourceLocation(Tutorial.MOD_ID,
            "textures/gui/display_case.png");

    public DisplayCaseScreen(GUICaseContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX,
        ...
        this.minecraft.textureManager.bindTexture(DISPLAY_CASE_GUI);// 绑定材质
