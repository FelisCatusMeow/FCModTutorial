...
public class BlockList {
    ...
    public static final RegistryObject<Block> TUTORIAL_BLOCK = BLOCKS.register("tutorial_block",
            () -> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(5, 6).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<RotateBlock> ROTATE_BLOCK = BLOCKS.register("rotate_block",
            () -> new RotateBlock(
                    Block.Properties.create(Material.ROCK).hardnessAndResistance(0.5F).sound(SoundType.STONE)));
